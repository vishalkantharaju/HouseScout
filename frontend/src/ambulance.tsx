...
export default function Ambulance() {
    ...
    function send_report() {
        ...
        const searchValue = urlParams.get('id');
        const data = {
            ambulance_id: searchValue,
            gender: gender,
            age: Number(age),
            heart_rate: Number(heartRate),
            resp_rate: Number(respRate),
            sp : Number(spo),
            bp: [120, 80],
            bs:4,
            sample: sam
        ...
        <div className="flex h-screen pt-16 w-7/12 bg-[#CCD6E1]">
            <div className="flex flex-col ml-10 w-full h-full">
                ...
                <div className='flex w-full justify-center'>
                    <div className = "bg-[#FFFF] mt-3 w-fit h-fit p-4 rounded-lg text-center">
                        <div className="  font-bold text-xl bg-clip-text text-transparent bg-[#0F284C]">
                            <p>Arriving at: {hospital}</p>
                        </div>
                        <div className="mt-1 font-bold text-xl bg-clip-text text-transparent bg-[#0F284C]">
                            <p>ETA: {ETA} mins</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Vitals Box */}
                <div className='flex w-full justify-center'>
                    <div className="w-fit px-8 pr-10 h-full bg-[#FFFF] mt-5 mb-5 h-full rounded-lg flex flex-col">
